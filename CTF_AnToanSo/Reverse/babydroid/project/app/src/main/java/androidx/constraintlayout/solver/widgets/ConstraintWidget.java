...
public class ConstraintWidget {
    ...
    */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:173:0x056c, code lost:
        ...
        if ((r4 instanceof androidx.constraintlayout.solver.widgets.Barrier) != false) goto L246;
     */
    ...
    /* JADX WARN: Removed duplicated region for block: B:84:0x063e A[ADDED_TO_REGION] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
