...
public class ViewCompat {
    ...
    class AnonymousClass1 implements OnReceiveContentViewBehavior {
        AnonymousClass1() {
        }
    ...
    class AnonymousClass2 extends AccessibilityViewProperty<Boolean> {
        AnonymousClass2(int tagKey, Class cls, int frameworkMinimumSdk) {
    ...
    class AnonymousClass4 extends AccessibilityViewProperty<CharSequence> {
        AnonymousClass4(int tagKey, Class cls, int contentChangeType, int frameworkMinimumSdk) {
            super(tagKey, cls, contentChangeType, frameworkMinimumSdk);
        }
    ...
    class AnonymousClass5 extends AccessibilityViewProperty<Boolean> {
        AnonymousClass5(int tagKey, Class cls, int frameworkMinimumSdk) {
            super(tagKey, cls, frameworkMinimumSdk);
        }
            ...
            if (listener == null) {
                ...
                v.setOnApplyWindowInsetsListener(new View.OnApplyWindowInsetsListener() { // from class: androidx.core.view.ViewCompat.Api21Impl.1
                    ...
                    public WindowInsets onApplyWindowInsets(View view, WindowInsets insets) {
                        ...
                        if (Build.VERSION.SDK_INT < 30) {
                            Api21Impl.callCompatInsetAnimationCallback(insets, r1);
                            if (compatInsets.equals(this.mLastInsets)) {
                                return r2.onApplyWindowInsets(view, compatInsets).toWindowInsets();
                            }
                        }
                        this.mLastInsets = compatInsets;
                        WindowInsetsCompat compatInsets2 = r2.onApplyWindowInsets(view, compatInsets);
                        if (Build.VERSION.SDK_INT >= 30) {
